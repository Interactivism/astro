(async () => {
  ...
  const TYPE_SCALE = [
    ...
    ["Hero Slide · Desktop", 90, 96,  "Playfair Display",  "SemiBold",  C.dark1, "Designing for the Human–AI Era"],
    ["Hero Slide · Mobile",  40, 50,  "Playfair Display",  "SemiBold",  C.dark1, "Designing for the Human–AI Era"],
